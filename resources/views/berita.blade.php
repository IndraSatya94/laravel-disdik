        ...
        <div class="sidebar">
          ...
          <div class="sidebar-item recent-posts">
            <div class="post-item clearfix">
              <img src="assets/img/berita/beritadisdik2.jpg" alt="">
              <h4><a href="berita-detail.html">Mulai Hari ini Guru – Guru di  Bolmong Selama Satu Minggu Bekerja Dari Rumah</a></h4>
              <time datetime="2020-01-01">23-03-2020</time>
            </div>

            <div class="post-item clearfix">
              <img src="assets/img/berita/beritadisdik3.jpg" alt="">
              <h4><a href="berita-detail.html">Dinas Pendidikan Sosialisasi Pencairan Dana BOS 2020</a></h4>
              <time datetime="2020-01-01">17-06-2020</time>
            </div>

            <div class="post-item clearfix">
              <img src="assets/img/berita/beritadisdik4.jpg" alt="">
              <h4><a href="berita-detail.html">Dinas Pendidkan Bolmong Gelar Kompetisi Siswa Nasional Tingkat Kabupaten</a></h4>
              <time datetime="2020-01-01">12-03-2020</time>
            </div>
